...
function Shell({ children }: { children: React.ReactNode }) {
  return (
    <AppShell
      badge="Livestock"
      eyebrow="First real module · live database"
      title="Livestock &amp; Herd Health"
      subtitle="Your herd at a glance — head counts by species, health events due, and horse energy needs, from the pasture gate."
    >
      {children}
    </AppShell>
  );
