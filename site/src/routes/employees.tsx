...
function Shell({ children }: { children: React.ReactNode }) {
  return (
    <AppShell
      badge="Employees &amp; Labor"
      eyebrow="Sixth module · live database"
      title="Employees &amp; Payroll-Lite"
      subtitle="Your roster and the labor-cost rollup — what each worker costs this month, and labor cost per head / per hour feeding the cost picture."
    >
      {children}
    </AppShell>
  );
