-- 0020_password_reset.sql — Secure password reset tables (Ranch Manager Pro).
-- Password_resets tables ONLY (no entitlement changes; migration 0019 owns those).
-- Additive only, idempotent with IF NOT EXISTS guards.
...
-- Applied via the normal migrate runner.
